...
int LastOccThatNo(int *ptr , int iLenght , int iNo )
{
...
int main( )
{
    ...
    iRet = LastOccThatNo( ptr , iLength , iNo );
...
85      66      3       66      93      88      Enter the number we check in that array :
66
The No 66 is  present in that array at 3 index  :
...
111
The elements of array are :
85      11      3       15      11      111     Enter the number we check in that array :
12
