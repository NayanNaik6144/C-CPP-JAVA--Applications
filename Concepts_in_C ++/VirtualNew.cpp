...
};    // siz eof base class is 8 bytes for vptr vtable and  8 bytes for two int
...
};   // size of derived  class is size of base class and size of characteristicks of derived class 16+8 = 24 bytes 
