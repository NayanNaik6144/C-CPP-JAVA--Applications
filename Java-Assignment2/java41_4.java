...
class MarvellousX extends ArrayX
{
    ...
    {
        System.out.println("The Odd elements from First Array are :");
        ...
        System.out.println("The Odd elements from Second Array are :");
...
45      6       12      18      23      4
The odd elements from First Array are :
9       5       3
The odd elements from Second Array are :
45      23
